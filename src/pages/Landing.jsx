  ...
  return (
    <div>
      ...
      {(loadingCategories || loadingProducts) && (
        <div className="w-full bg-gray-950 animate-pulse min-h-screen">
          <Loader />
        </div>
      )}
      ...
      {!(loadingCategories || loadingProducts) &&
        products &&
        products.length > 0 && (
          <div className="bg-gray-950 text-white  px-6 py-32 md:py-18">
            <header className="text-center ">
              <h1 className="sm:text-4xl text-4xl font-bold mb-2">
            ...
            <div className="mx-2 mb-10 md:mx-20">
