...
export default function ProductDetail() {
  ...
  return (
      <>
            ...
            <div className="text-white py-10"> No hay existe el producto</div>
            )}
              ...
              <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row gap-10 justify-items-center">
                  ...
                  <div className="md:w-1/2">
                    <div className="max-w-[230px] 
                      ...
                      <img 
                        ...
                        src={productoURLImagen.pictures}
                  ...
                  <div className="md:w-1/2 flex flex-col justify-between">
                    <div>
                      <h2 className="text- text-3xl font-bold mb-2">{productoURLImagen.title}</h2>
                      {/* Precio */}
                    ...
                    <div className="mt-8 flex gap-4">
                        <BotonLargo textoBoton={"Añadir al carrito"} funcionClick={()=>addMultiple(productoURLImagen,counter)}/>
                        <div className="flex items-center bg-green-700 text-white hover:bg-green-900 transition rounded-lg font-bold">
                              {/*Boton menos*/ }
                              <button className="cursor-pointer px-3 py-2 md:px-3 md:py-3" onClick={()=> setCounter(counter - 1)} disabled={counter===1}>
                                  <svg xmlns="http://www.w3.org/2000/svg" className="w-2.5 fill-current" viewBox="0 0 124 124">
                                      <path d="M112 50H12C5.4 50 0 55.4 0 62s5.4 12 12 12h100c6.6 0 12-5.4 12-12s-5.4-12-12-12z" data-original="#000000"></path>
                                  </svg>
                              </button>
                              {/*Cantidad de productos*/ }
                              <span className="mx-3 px-3 py-2 md:px-3 md:py-3">{counter}</span>
                              {/*Boton mas*/ }
                              <span className="cursor-pointer px-3 py-2 md:px-3 md:py-3" onClick={()=>setCounter(counter + 1)}>
