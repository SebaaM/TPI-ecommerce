...
function BotonMovil ({textoBoton,funcionClick}){
...
return (<div>
    ...
    >
        <span className="hidden bg-green-500 md:inline">{textoBoton}</span>
              <svg
                className="h-6 w-6 block bg-green-500 md:hidden text"
                viewBox="0 0 24 24"
