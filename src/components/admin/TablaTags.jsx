  ...
  return (
    <div className="mt-10">
      ...
      <div className="flex justify-between">
        ...
        <button
          className="w-48 hidden md:block px-4 py-2 mb-2 bg-teal-600 hover:bg-teal-700 text-white rounded shadow text-base font-bold"
          onClick={openModalNew}
        >
          + Agregar tag
        </button>
        <button
          className="block md:hidden px-4 py-2 mb-2 bg-teal-600 hover:bg-teal-700 text-white rounded shadow text-base font-bold"
          onClick={openModalNew}
        >
          +Tag
        </button>
            ...
            <table className="min-w-full bg-gray-900 text-gray-200">
              ...
              <tbody className="border border-gray-700">
                {tagsFiltrado.map((tag) => (
                  <tr
                    key={tag.id}
                    className="grid grid-cols-[1fr_140px] items-center border-t border-gray-700"
                  >
